            ...
            else
            {
                try {
                    ...
                    if (con == null) {
                        ...
                        String query="insert into test_connect values('"+namestr+"','"+emailstr+"','"+passstr+"')";
            ...
            else
            {
                try {
                    ...
                    if (con == null) {
                        ...
                        String query=" select * from test_connect where name ='"+namestr+"' and email='"+emailstr+"' and pass = '"+passstr+"'";
